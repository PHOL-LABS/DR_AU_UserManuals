...
\section{\DRAudi{} Command Reference}

The \DRAudi{} firmware shares most commands with the miniUIOD interface.
Commands 31--33 (colour control) are only active on firmware revisions that support RGB configuration; other commands apply equally to the Bluetooth and Wi-Fi workflows.

\begin{table}[htbp]
    \centering
    \caption{Primary configuration commands for the \DRAudi{} dashboard.}
    ...
    \begin{tblr}{
        ...
        17 & PARAMETER\_BUZZER\_OFF & Disable buzzer (if fitted). \\
        ...
        31--33 & PARAMETER\_MAINCOLOR\_[RGB] & UI colour components (RGB-enabled firmware only). \\
...
\section{\DRAudi{} Default Values}

\begin{table}[htbp]
    \centering
    \caption{Default configuration for the \DRAudi{} dashboard.}
    ...
    \begin{tblr}{
        ...
        PARAMETER\_BRIGHTNESS\_LEVEL & 7 or 13 & Typical Bluetooth defaults (25 on Wi-Fi units). \\
        ...
        PARAMETER\_MAINCOLOR\_[RGB] & -- & Colour commands active only on RGB-enabled firmware. \\
