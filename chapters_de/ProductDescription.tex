...
\section{Kompatibilit\"at elektronischer Geschwindigkeitssensoren}
Das Kombiinstrument akzeptiert einen handels\"ublichen elektronischen Fahrzeug-Geschwindigkeitssensor; praktisch jeder elektronische Geschwindigkeitssensor, der das normale Getriebe-Geschwindigkeitssignal liefert, ist elektrisch kompatibel.
Empfohlen wird der Sensor \texttt{191919149D}, auch geliefert als \texttt{NTYECP-AU-033}; \texttt{357919149B}/\texttt{357919149} wird ebenfalls empfohlen, besonders f\"ur O2A- und O2J-Getriebe.

Alternative kompatible Sensoren sind \texttt{IG0919149A}/\texttt{1H0919149A} mit Gegenstecker \texttt{357972753} oder \texttt{1H0919149C} mit dem anderen Gegenstecker \texttt{1J0973723}.
Diese Alternativen verwenden denselben Signaltyp und sind mit dem Kombiinstrument vollst\"andig elektrisch kompatibel.

Die Farbe des im Getriebe montierten Antriebszahnrads ist nicht entscheidend: ein Getriebe mit wei\ss{}em oder rotem Zahnrad funktioniert, und auch ein Geschwindigkeitssensor mit rotem Zahnrad ist geeignet.
Das Tachosignal wird an den 14-poligen (2\,$\times$\,7) KF2510-Stecker f\"ur Zusatzsignale angeschlossen; der Eingangspin des Geschwindigkeitssensors ist in der obenstehenden Service-Stecker-Pinbelegung angegeben.
