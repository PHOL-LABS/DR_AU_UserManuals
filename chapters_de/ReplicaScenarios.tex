\chapter{Typical situations for setting up the \DRAudi{}}\label{ch:replica-scenarios}

Before troubleshooting, confirm whether you are using the Bluetooth-based configuration workflow (\autoref{ch:replica-setup}) or the miniUIOD Wi-Fi portal (\autoref{ch:replica-next-setup}).
...
\begin{description}
    ...
    \item[iPhone or iPad cannot connect] The Bluetooth~2.0 interface is incompatible with iOS devices. Use an Android phone or a computer running a Bluetooth serial utility.
