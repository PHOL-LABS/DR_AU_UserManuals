...
\section{Referencia de comandos para \DRAudi{} clásico}

El firmware clásico DR Audi comparte la mayoría de los comandos con \DRAudi{}.
Los comandos 31--33 (control de color) solo están activos en unidades \DRAudi{}; el resto se aplica por igual a ambas generaciones.

\begin{table}[htbp]
    \centering
    \caption{Comandos principales de configuración para cuadros \DRAudi{} clásicos.}
    ...
    \begin{tblr}{
        ...
        17 & PARAMETER\_BUZZER\_OFF & Desactivar el zumbador (solo DR Audi). \\
...
\section{Valores predeterminados de \DRAudi{} clásico}

\begin{table}[htbp]
    \centering
    \caption{Configuración predeterminada para el \DRAudi{} clásico.}
    ...
    \begin{tblr}{
        ...
        PARAMETER\_MAINCOLOR\_[RGB] & -- & Comandos de color no activos en el DR Audi. \\
