...
Este capítulo reúne las normas de seguridad obligatorias que acompañan a cada cuadro de instrumentos \DRAudi{} y \DRAudi{}. Ignorar cualquiera de estos puntos es la forma más rápida de dañar la electrónica u obtener lecturas poco fiables.
...
\begin{enumerate}
    ...
    \item \textbf{Recuerde que los paneles de las versiones anteriores no tienen fusible interno.} El primer elemento de protección es el fusible de 15~A de la caja de fusibles de Audi. Reacciona demasiado tarde para salvar el cuadro ante errores de cableado.
