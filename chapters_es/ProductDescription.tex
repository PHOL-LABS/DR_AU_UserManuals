...
\section{Finalidad}
Los cuadros \DRAudi{} y \DRAudi{} sustituyen a los conjuntos de instrumentos originales de Audi y amplían su funcionalidad. Ofrecen indicaciones digitales de velocidad, régimen del motor, temperatura del refrigerante, nivel de combustible y cálculos auxiliares de la MFA, y son compatibles tanto con sensores de velocidad por cable como electrónicos. Las unidades \DRAudi{} integran un controlador Bluetooth, mientras que \DRAudi{} añade módulos de configuración mediante Wi-Fi y unidades de expansión opcionales.
...
\begin{description}
    ...
    \item[Posición~4] \textbf{T} para el mazo anterior al facelift (de 10 pines) o \textbf{S} para el mazo posterior (de 12 pines).
\end{description}
...
\begin{description}
    ...
    \item[K] Kelvin.
\end{description}
Por ejemplo, un cuadro \texttt{GART-AR} es una unidad de gasolina, ensamblada en fábrica, con sensor electrónico, mazo de 12 pines, tacómetro de 8000~RPM y unidades de medida imperiales.
...
NEXT-GART & \DRAudi{}, escala de 8000~RPM, dos conectores, sensor de velocidad electrónico. \\
NEXT-GARS & \DRAudi{}, escala de 8000~RPM, un conector, sensor de velocidad electrónico. \\
NEXT-MT & Kit de autoensamblaje \DRAudi{} con dos conectores. \\
NEXT-MS & Kit de autoensamblaje \DRAudi{} con un conector. \\
\end{tblr}}
...
\begin{figure}[htbp]
    ...
    \caption{Distribución de conectores para cuadros \DRAudi{} con dos enchufes.}
\end{figure}
...
10 & Alimentación positiva permanente UNR (sin uso en \DRAudi{}, alimentación principal en \DRAudi{}). \\
11 & Conductor “+” de temperatura MFA para el sensor ambiental (\DRAudi{}). \\
12 & Conductor del sensor de temperatura de aceite MFA (solo \DRAudi{}). \\
...
\begin{figure}[htbp]
    ...
    \caption{Distribución de un solo conector utilizada en los cuadros DR Audi compactos.}
    \label{fig:single-connector}
\end{figure}

\subsection{Mazo prospectivo Audi (variante alternativa)}
El mazo prospectivo para Audi (variante alternativa) utiliza dos conectores. Sus funciones se resumen a continuación.
...
Los vehículos Audi Mk1 utilizan las siguientes asignaciones:
\begin{enumerate}
...
El tercer conector de la placa replica los conectores del cuadro, con pines numerados de derecha a izquierda en las unidades \DRAudi{} y \DRAudi{}. Proporciona una interfaz de servicio con las asignaciones listadas en \autoref{tab:service-connector}.
...
\begin{table}[htbp]
    ...
    \begin{tblr}{
        ...
        10 & Entrada alternativa de RPM (sin uso, solo \DRAudi{}). \\
        11 & \DRAudi{}: salida de indicador (normalmente desconectada); \DRAudi{}: entrada de freno (activa en bajo). \\
        12 & Reservado. \\
...
\displayurl{https://github.com/PHOL-LABS/DR_AU_UserManuals}
Hay dos juegos de entrega disponibles:
\begin{itemize}
    \item \textbf{\DRAudi{}:} conjunto del cuadro, mazo de temperaturas ambiente y de aceite, programador USBasp y, para sensores remotos, mazo del sensor de velocidad.
    \item \textbf{\DRAudi{}:} conjunto del cuadro y mazo del sensor de velocidad electrónico.
\end{itemize}
