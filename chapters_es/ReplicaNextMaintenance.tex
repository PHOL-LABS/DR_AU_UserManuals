\chapter{Configuración y mantenimiento de miniUIOD}\label{ch:replica-next-setup}

Esta sección se aplica al cuadro \DRAudi{} mostrado en \autoref{fig:next-hardware}.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.6\textwidth]{digifiz_manual/image019.png}
\caption{Conjunto del cuadro \DRAudi{}.}
...
\begin{itemize}
    \item Conéctese al punto de acceso Wi-Fi del tablero. Desactive los datos móviles y únase a \texttt{DRAudi\_AP} (contraseña \texttt{87654321}); algunas revisiones anuncian \texttt{DRAudi\_AP} con la misma contraseña.
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{Interfaz Wi-Fi de \DRAudi{}.}
...
\begin{table}[htbp]
    \centering
    \caption{Comandos principales de configuración de \DRAudi{}.}
    ...
    \begin{tblr}{
        ...
        15 & \paramname{PARAMETER\_TANK\_CAPACITY} & Capacidad del depósito en litros (0--99; 55~L típico en Audi 80 B2). \\
        16 & \paramname{PARAMETER\_MFA\_STATE} & Modo MFA activo (normalmente se controla por hardware). \\
        17 & \paramname{PARAMETER\_BUZZER\_OFF} & Desactivar zumbador (1 lo desactiva, 0 lo habilita; \DRAudi{} no incluye zumbador). \\
        ...
        24 & \paramname{PARAMETER\_BACKLIGHT\_ON} & Activar retroiluminación con luces de cruce (sin uso en \DRAudi{}). \\
...
\begin{table}[htbp]
    \centering
    \caption{Valores predeterminados de \DRAudi{}.}
