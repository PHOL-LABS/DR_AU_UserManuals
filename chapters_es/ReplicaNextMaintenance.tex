...
\begin{itemize}
    \item Conéctese al punto de acceso Wi-Fi del tablero. Desactive los datos móviles y únase a \texttt{DRAudi_AP} (contraseña \texttt{87654321}); algunas revisiones anuncian \texttt{DRAudi_AP} con la misma contraseña.
