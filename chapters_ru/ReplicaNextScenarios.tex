\chapter{Typical situations for using the miniUIOD interface}\label{ch:replica-next-scenarios}
...
\begin{description}
    ...
    \item[Speed reading incorrect] Connect via Wi-Fi, drive at an indicated \SI{100}{\kilo\metre\per\hour}, note the GPS speed, then issue \verb|1 <gps_value>| (for example, \verb|1 85|) to set \paramname{PARAMETER\_SPEEDCOEEFICIENT} to the verified value.
